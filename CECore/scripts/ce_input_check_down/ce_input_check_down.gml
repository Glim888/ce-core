/// @func ce_input_check_down(action[, controller])
/// @desc Checks whether a control for an action in the current input scheme is held down.
...
return ce_input_check(argument[0], CE_EInputState.Down,
